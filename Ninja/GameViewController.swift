...
class GameViewController: UIViewController {
  ...
  func setupScene() {
    ...
    scnScene.background.contents =
      "Ninja.scnassets/Textures/Background_Diffuse.png"
  }
  ...
  func setupSplash() {
    splashNodes["TapToPlay"] = createSplash(name: "TAPTOPLAY", imageFileName: "Ninja.scnassets/Textures/TapToPlay_Diffuse.png")
    splashNodes["GameOver"] = createSplash(name: "GAMEOVER", imageFileName: "Ninja.scnassets/Textures/GameOver_Diffuse.png")
    showSplash(splashName: "TapToPlay")
  }
  
  func setupSounds() {
    game.loadSound("ExplodeGood", fileNamed: "Ninja.scnassets/Sounds/ExplodeGood.wav")
    game.loadSound("SpawnGood", fileNamed: "Ninja.scnassets/Sounds/SpawnGood.wav")
    game.loadSound("ExplodeBad", fileNamed: "Ninja.scnassets/Sounds/ExplodeBad.wav")
    game.loadSound("SpawnBad", fileNamed: "Ninja.scnassets/Sounds/SpawnBad.wav")
    game.loadSound("GameOver", fileNamed: "Ninj.scnassets/Sounds/GameOver.wav")
  }
